...
export const smokeAndMirrorsQuietScenario: ScenarioDefinition = {
  ...
  acts: [
    ...
    {
      id: "smoke-and-mirrors-quiet-act-2",
      kind: "act",
      sequence: "2a",
    ...
    {
      id: "smoke-and-mirrors-quiet-act-3",
      kind: "act",
      sequence: "3a",
    ...
    {
      id: "smoke-and-mirrors-quiet-act-4",
      kind: "act",
      sequence: "4a",
  ...
  agendas: [
    {
      id: "smoke-and-mirrors-quiet-agenda-1",
      kind: "agenda",
      sequence: "1a",
      title: "Past Curfew",
    ...
    {
      id: "smoke-and-mirrors-quiet-agenda-2",
      kind: "agenda",
      sequence: "2a",
      title: "Lit Up",
    ...
    {
      id: "smoke-and-mirrors-quiet-agenda-3",
      kind: "agenda",
      sequence: "3a",
      title: "Wild Flames",
