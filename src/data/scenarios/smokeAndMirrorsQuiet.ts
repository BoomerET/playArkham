...
export const smokeAndMirrorsQuietScenario: ScenarioDefinition = {
  ...
  enemySpawns: [],
  introText: [
    "You follow Dr. Armitage back to his apartment. A veil of black smoke obscures \
the moon and stars as a warm breeze carries ash and embers through the \
familiar city streets.",
    "“I’ve had my suspicions that something foul was afoot. Several students have \
disappeared in the last few weeks,” the head librarian tells you. “All of them \
began to exhibit strange behaviors after attending a supposedly exclusive \
‘meeting’ off campus not long ago. They complained of horrible, incessant \
whispers and a strange bruise that suddenly appeared on their skin. And then, \
they vanished.”",
    "Fearing the worst, you ask him about your friend. “They insisted we meet earlier \
today,” he replies. “They told me that an organization calling themselves the \
‘Brethren of Ash’ have been inviting students and vulnerable citizens to these \
strange assemblies. Your friend listed a number of individuals who attended, \
although it is unclear whether they were prospective recruits or loyal adherents. \
Before they left, your friend spoke of another meeting tonight. A gathering of all \
the faithful. I don’t know why, but the thought of it fills me with an inutterable \
dread. And now your friend is gone,” he says dourly.",
    "You resolve to interrogate the list of suspects and then meet at Velma’s Diner \
in Easttown before midnight. The head librarian suggests you use a light touch \
rather than a more heavy-handed approach, which could alert the cabal. \
However, you worry you will not have any other choice."
  ],
  chaosBags: {
    easy: [
      1, 1, 0, 0, 0, -1, -1, -1, -2, -2,
