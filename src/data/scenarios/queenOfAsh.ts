...
of Ash, has been eradicated in the inferno.",
  ...
  encounterCardCodes: [
    ENCOUNTER_CARD_CODES.ZEALOT,
    ENCOUNTER_CARD_CODES.ZEALOT,
    ENCOUNTER_CARD_CODES.ZEALOT,
    ENCOUNTER_CARD_CODES.DARK_MAGICIAN,
    ENCOUNTER_CARD_CODES.BLASPHEMOUS_INVOCATION,
    ENCOUNTER_CARD_CODES.BLASPHEMOUS_INVOCATION,
    ENCOUNTER_CARD_CODES.LANGUOR,
    ENCOUNTER_CARD_CODES.LANGUOR,
    ENCOUNTER_CARD_CODES.DISSONANCE,
    ENCOUNTER_CARD_CODES.DISSONANCE,
    ENCOUNTER_CARD_CODES.TORMENT,
    ENCOUNTER_CARD_CODES.TORMENT,
    ENCOUNTER_CARD_CODES.UNNATURAL_DECAY,
    ENCOUNTER_CARD_CODES.UNNATURAL_DECAY,
    ENCOUNTER_CARD_CODES.PUTRID_VAPORS,
    ENCOUNTER_CARD_CODES.PUTRID_VAPORS,
  ],
};
